...
- **Openness** — [SSH](/shell/), [deployment methods](/deployment/), data export
...
Deploy something. Many providers offer a [free tier or a trial](/pricing/) with or without a credit card, and an afternoon of actually shipping to a platform tells more than a week of tables. 

## Follow the devs

If you are the boss, or the client, just let your developer pick. Whoever will live with the hosting daily should make the call: developer experience is a real cost, paid every week, and it is invisible on a specs table.
