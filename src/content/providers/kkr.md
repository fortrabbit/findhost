...
figure:
  emoji: 💼
  color: rgb(38, 46, 66)
  textColor: rgb(234, 237, 244)
  text: Investment firm, majority owner of a server provider.
ai: authored
---

A global investment firm, recorded here because it holds the majority stake in a company this register lists, alongside a minority held by that company's previous owner. It sells no hosting of its own.
