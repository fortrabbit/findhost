...
SpinupWP is [server management software](/category/server-management/) built around WordPress. It connects over SSH to an Ubuntu server the customer already owns — [DigitalOcean](/providers/digitalocean/), [Linode](/providers/linode/), [Vultr](/providers/vultr/), [Hetzner](/providers/hetzner/), [AWS](/providers/aws/) EC2 or Lightsail and [Google Cloud](/providers/gcp/) are named, alongside "any server provider" — and configures a stack of Nginx, PHP-FPM, MySQL and Redis with WP-CLI, Composer and Let's Encrypt certificates. Deployment is push-to-deploy over git, and full SSH access to the machine stays with the customer. Site cloning and staging environments are part of the panel.
