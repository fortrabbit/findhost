...
referringSubnets: { now: 527, before: 525 }
status: unlisted
...
It is recorded for the same reason as any other parent: a group like this is where the decisions that reach a customer are made, and the brands are what a reader compares. Whether a provider is owned this way is a field on its own record, under [ownership](/ownership/).
