...
The name promises rather more inclusion than the entry tariff delivers. SSH is withheld from the two cheapest plans, cron jobs cost extra on the entry package and DNS editing begins one tier up. PHP versions are not stated on the tariff comparison, so what a plan actually runs has to be established from the panel.
