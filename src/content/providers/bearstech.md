...
This is a genuine and distinctive company, and the rejection says nothing about its quality — only that it is a service business sold by conversation rather than a purchasable hosting product. That is a real category, and this dataset does not cover it. Publishing a rate card for any single managed offer would be enough to list it.
