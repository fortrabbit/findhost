...
regions:
  - DE
entryPrice: { amount: 5.03, currency: EUR, period: month }
priceFrom: sm
priceTo: md
currencies:
  - EUR
...
audience:
  - smb
  - solo
referringSubnets: { now: 636, before: 637 }
status: active
...
Four plans, PHP 8.1 to 8.4, MySQL, MariaDB or PostgreSQL, and up to fifty SSH users on an account. The entry tier advertises one euro a month for six months and then €5.03, which is the price recorded here.
