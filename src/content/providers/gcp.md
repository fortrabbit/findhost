...
PHP has several entry points on GCP: App Engine ships maintained PHP 8 runtimes, [Cloud Run](/providers/google-cloud-run/) runs PHP as a container, and Compute Engine offers plain VMs. MySQL is another service again, Cloud SQL. Each piece works well — and each is picked, configured, connected and billed on its own.
