...
name: Code Storage
urls:
  home: https://code.storage
  pricing: https://code.storage/pricing
  docs: https://code.storage/docs
category:
  - git-hosting
description: Git repository hosting reached through an API and SDKs rather than a web interface, sold to products that create repositories on behalf of their users.
hqCountry: US
runtimes: null
deployMethods: null
sshAccess: null
