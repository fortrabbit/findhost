...
In cloud computing acronyms, [IaaS](/guide/categories/iaas/) is the ground level, PaaS sits on top of it, and SaaS is the last layer.
...
PaaS is professional, usually language-agnostic, containerised, service-oriented cloud hosting. The boundaries to [VPS](/guide/categories/vps/) on one side and [serverless](/guide/categories/serverless/) on the other are blurred.
