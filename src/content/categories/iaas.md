...
id: iaas
title: IaaS
description: Cut out the middleman, keep the change?
figure:
  emoji: 🏗️
  color: "#607D8B"
...
In cloud computing acronyms, IaaS is the foundational layer. On top of that is [PaaS](/guide/categories/paas/), followed by the SaaS layer. Where a provider sits is recorded as [who manages the operating system](/os-managed-by/) and [whose hardware it runs on](/hardware/).
