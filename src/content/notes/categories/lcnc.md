...
The difference from [shared hosting](/categories/shared-hosting/) or [PaaS](/categories/paas/) is not the price or the audience but where the work happens. There is no deploy step, so there is usually no [SSH](/ssh/), no runtime to choose and nothing to record under [software](/software/) — the platform is the runtime. Most records here answer "provider" to [who manages the operating system](/os-managed-by/), because there is no operating system on the customer's side of the line at all.
